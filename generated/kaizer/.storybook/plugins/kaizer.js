...
export const defRender = (args, componentDescription, twigPath = null) => {
  let component = {};
  if (componentDescription) {
    component = Object.values(componentDescription)[0];
  }
  ...
  Object.entries(args).forEach(([argName, argValue]) => {
    ...
    if (component && component.settings && component.settings[argName]) {
