...
import breakpoints from '../my_custom_theme.breakpoints.yml';
...
const myCustomThemeBreakpoints = Object.keys(breakpoints).reduce(
  (a, i) =>
    Object.assign(a, {
...
window.drupalSettings = {
  myCustomThemeSvgSprite: svgSprite,
  myCustomThemeBreakpoints,
};
