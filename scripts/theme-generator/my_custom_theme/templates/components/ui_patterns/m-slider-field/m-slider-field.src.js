...
(({ behaviors }) => {
  behaviors.myCustomThemeMoleculeSliderField = {
    attach: (context) => {
      once('m-slider-field', '.m-slider-field', context).forEach((el) => {
        ...
        if (sliderEl) {
          if (el.classList.contains('m-slider-field--type-1')) {
            behaviors.myCustomThemeMoleculeSliderField.typeOne(sliderEl);
          } else if (el.classList.contains('m-slider-field--type-2')) {
            behaviors.myCustomThemeMoleculeSliderField.typeTwo(sliderEl);
          } else {
            behaviors.myCustomThemeMoleculeSliderField.typeOne(sliderEl);
          }
        }
