...
import breakpoints from '../super_custom_theme.breakpoints.yml';
...
const superCustomThemeBreakpoints = Object.keys(breakpoints).reduce(
  (a, i) =>
    Object.assign(a, {
...
window.drupalSettings = {
  superCustomThemeSvgSprite: svgSprite,
  superCustomThemeBreakpoints,
};
