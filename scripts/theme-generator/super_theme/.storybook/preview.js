...
import breakpoints from '../super_theme.breakpoints.yml';
...
const superThemeBreakpoints = Object.keys(breakpoints).reduce(
  (a, i) =>
    Object.assign(a, {
...
window.drupalSettings = {
  superThemeSvgSprite: svgSprite,
  superThemeBreakpoints,
};
